...
需要说明的是，`__proto__`并不是EcmaScript标准中的一部分，只是浏览器中的实现。而刚刚说到的`getPrototypeOf`和`setPrototypeOf`是方法ES2015标准中的。
...
**原型链存在的意义就在于将一类对象中共有的属性/方法串联起来，而不必每个对象都自己持有一份。**
...
// 此处假定fn是Person构造函数的实例
fn.__proto__ === Person.prototype
fn.__proto__.__proto__ === Person.prototype.__proto__
fn.__proto__.__proto__ === Function.prototype.__proto__
fn.__proto__.__proto__ === Object.prototype
Person.__proto__ === Function.prototype
Person.prototype.__proto__ === Function.prototype.__proto__ // 百思不得解 

arr.__proto__ === Array.prototype // 此处假定arr是Array构造函数的实例
...
// 因为Object本身是个函数，本质上和 名为Person的构造函数没差
