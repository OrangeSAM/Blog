...
6. 你转发的"残酷底层无语"或只是某视频软件的软文
   1. 调动情绪比调动理性要容易一万倍。
   2. 如果假设和输入的信息错了，再精准的模型，输出来的也只是精准的错误。
   3. 聪明是天赋，而善良是一种选择。
   
7. 王宝强离婚启示：动态平衡的关系才能走到最后
